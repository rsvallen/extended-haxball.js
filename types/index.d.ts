...
declare class RoomObject {
  ...
  getInputObject(playerId: number): InputObject;
  ...
  setPlayerRank(playerId: number, rank: number): void;
  ...
  onPlayerKickPress(player: PlayerObject): void;

  onPlayerKickRelease(player: PlayerObject): void;
